...
{
    /// <inheritdoc />
    public partial class newfirstproject : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerDocument_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaintenanceCostPerHour = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ElectricityConsumptionPerHour = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialQuantity = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderServices_Materials_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRecord_EquipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderServices_EquipmentId",
                table: "OrderServices",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderServices_MaterialId",
                table: "OrderServices",
                column: "MaterialId");
